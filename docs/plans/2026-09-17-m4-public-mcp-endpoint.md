...
- [ ] Chạy full `bun test` trên runner có symlink support; Windows local hiện có 32 lỗi fixture `EPERM`.
...
- [ ] Xác nhận cross-platform CI cho M3 #36 trước khi đóng Epic #29 hoặc đánh dấu M4/roadmap production-ready.
